...
//    BumperState bumperState_Left = BumperState.BS_OFF;
//    BumperState bumperState_Right = BumperState.BS_OFF;
...
////                    if (intakeHand == IntakeHand.IH_LEFT) {
////
////                        if (bumperState == BumperState.BS_OFF)
////
////                        i_topLeft.setPosition(i_maxRange_topLeft);
////                        i_bottomLeft.setPosition(i_maxRange_bottomLeft);
////
...
//            }
//
//            switch (bumperState_Left) {
//
//                case BS_OFF:
//
//                    if (gamepad1.left_bumper) {
//
//                        bumperState_Left = BumperState.BS_ON;
//                    }
//
//                case BS_ON:
//
...
//                case CS_TURNING:
//
//                    if (carouselTime.milliseconds() > 1000) {
//
//                        carouselState = CarouselState.CS_HALF;
//
...
//                        carouselTime.reset();
//
//                        carouselState = CarouselState.CS_MAX;
//
...
//                    if (carouselHand == CarouselHand.CH_LEFT) {
//
//                        if (carouselTime.milliseconds() > 300) {
//
//                            c_Left.setPower(1.0);
//                            c_Right.setPower(1.0);
//
//                            carouselState = CarouselState.CS_COMPLETE;
//                        }
//                    } else if (carouselHand == CarouselHand.CH_RIGHT) {
//
//                        if (carouselTime.milliseconds() > 300) {
